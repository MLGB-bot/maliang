...
def on_setup():
    ...
    app.text(text, 0 , 0 , text_size=24, text_color=(0,0,255, ), font=f1)
    app.text(text, 0 , 200 , text_size=24, text_color=(0,0,255, ), font=f1)
...
def on_draw():
    ...
    app.text("FONT, 你好sjf坏大hi我的\n安怀海端是阿汉地\n的赛的话uida", random.randint(0, app.width/2), random.randint(0, app.height-12), font=f1)
