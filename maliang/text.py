...
class Text:
    ...
    def text(self, text, x=0, y=0, text_size=None, text_color=None, font: MFont = None):
        ...
        if font:
            font.text(text, x, y, text_size=text_size, text_color=tuple(MColor(*text_color)))
        else:
    ...
    def text_image(self, text, text_size=12, text_color=None, font: MFont = None):
        ...
        text_color = text_color or self.text_color
        if font:
            img = font.text_image(text, text_size=text_size, text_color=tuple(MColor(*text_color)))
        else:
            img = MImage()
